...
Task.create(description: "Email contact", user_id: 1, job_id: 1, is_completed: false)
Task.create(description: "Build Reddit clone", user_id: 1, job_id: 1, is_completed: false)
Task.create(description: "Find LinkedIn connections", user_id: 1, job_id: 1, is_completed: false)
